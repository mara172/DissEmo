...
\thispagestyle{empty}
\include{Kapitel/Emotionsbegriff_Allgemein}
\include{Kapitel/Emotionsbegriff_Philo}
\include{Kapitel/Emotionsbegriff_Psycho}
\include{Kapitel/Emotionsbegriff_Neuro}
\include{Kapitel/Emotionsbegriff_Comp}
\thispagestyle{empty}
\include{Kapitel/Emotionsmodelle}
\thispagestyle{empty}
\include{Kapitel/EmotionsmodellSVW}
\thispagestyle{empty}
\include{Kapitel/EmotionsmodellMaCeLot}
\thispagestyle{empty}
